...
public class DeliveryManager : MonoBehaviour
{
    ...
    [SerializeField]
    public List<Types.Meats> meatTypes;
    ...
    public bool DeliverMeat(List<Types.Meats> requiredMeats, int maxBoxesToDeliver=Constants.MAX_MEAT_DELIVERY_SPOTS)
    {
        // Cant deliver enough
        ...
        List<Types.Meats> meatBoxes = PopulateMeatList(requiredMeats, maxBoxesToDeliver);
    ...
    private List<Types.Meats> PopulateMeatList(List<Types.Meats> requiredMeats, int boxesToDeliver)
    {
        // Copy over required meats
        List<Types.Meats> finalMeats = new List<Types.Meats>(requiredMeats);
        ...
        for ( int i = 0; i < boxesToDeliver - initialCount; i++ )
        {
            ...
            Types.Meats meatType = meatTypes[meatIdx];
