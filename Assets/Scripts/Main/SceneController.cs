...
public static class Scenes {
    ...
    public const string GameOverMenu = "GameOverScene";
    public const string WinMenu = "WinScene";
}
...
public class SceneController : MonoBehaviour {
    private IDictionary<string, GameState> gameSceneStateMapping = new Dictionary<string, GameState>() {
        ...
        {Scenes.WinMenu, GameState.WIN_SCREEN},
        {Scenes.GameOverMenu, GameState.GAME_OVER_SCREEN},
    };
